...
require_once CLASS_PATH.'/AnnoLoader/Class/Map.php';

/**
 * Test class for AnnoLoader_Class_Map.
 * Generated by PHPUnit on 2011-01-14 at 15:41:30.
 */
class AnnoLoader_Class_MapTest extends PHPUnit_Framework_TestCase {

	/**
	 * @var AnnoLoader_Class_Map
	 */
	protected $object;
	...
	{
		$this->object = new AnnoLoader_Class_Map();
	}
	...
	{
		$this->object = new AnnoLoader_Class_Map(array
		(
			'Ext.ex'	=> 'lib/ex',
			'Ext.ux'	=> 'lib/ux',
		));
